class Nomina:
    def __init__(self, id_nomina, año_mes, id_empleado, nombre_empleado, apellido_empleado, id_contrato, tipo_contrato,
                 salario, id_seguridad_social, salud_empleado, pension_empleado, total_prestaciones_empleado,
                 total_prestaciones_empresa, valor_arl, id_parafiscales, total_parafiscales, id_novedad,
                 id_tipo_novedad, descripcion_novedad, fecha_novedad, valor_novedad, id_tiempo_trabajado, dias_pagados,
                 horas_extras_diurna, valor_extras_diurnas, horas_extras_nocturnas, valor_extras_nocturnas,
                 horas_dominicales, valor_dominicales, horas_festivas, valor_festivos, cant_horas_deducidad,
                 valor_deduccion_horas, total_devengo, total_deducciones, total_sueldo):
...
nomina1 = Nomina(id_nomina=1, año_mes="2023-09-01", id_empleado=101, nombre_empleado="Juan", apellido_empleado="Perez",
                 id_contrato=201, tipo_contrato="Contrato Fijo", salario=2500.0, id_seguridad_social=301,
                 salud_empleado=100.0, pension_empleado=50.0, total_prestaciones_empleado=300.0,
                 total_prestaciones_empresa=250.0, valor_arl=10.0, id_parafiscales=401, total_parafiscales=30.0,
                 id_novedad=501, id_tipo_novedad=601, descripcion_novedad="Vacaciones", fecha_novedad="2023-08-15",
                 valor_novedad=200.0, id_tiempo_trabajado=701, dias_pagados=30.0, horas_extras_diurna=5.0,
                 valor_extras_diurnas=50.0, horas_extras_nocturnas=2.0, valor_extras_nocturnas=30.0,
                 horas_dominicales=4.0, valor_dominicales=40.0, horas_festivas=3.0, valor_festivos=60.0,
                 cant_horas_deducidad=1.0, valor_deduccion_horas=10.0, total_devengo=2600.0,
                 total_deducciones=150.0, total_sueldo=2450.0)

# Usar métodos getter para obtener valores
print("ID de Nomina:", nomina1.get_id_nomina())
print("Año y Mes:", nomina1.get_año_mes())
print("Nombre del Empleado:", nomina1.get_nombre_empleado())

# Usar métodos setter para actualizar valores
nomina1.set_salario(2600.0)
nomina1.set_valor_novedad(250.0)

# Verificar los cambios
print("Nuevo Salario:", nomina1.get_salario())
print("Nuevo Valor de Novedad:", nomina1.get_valor_novedad())
